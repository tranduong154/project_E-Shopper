...
<head>
	...
	<link type="text/css" rel="stylesheet" href="{{asset('fontend/css/rate.css')}}">
    <!--[if lt IE 9]>
				...
				<div class="row">
					<div class="col-md-4 clearfix">
						<div class="logo pull-left">
							<a href="{{url('/fontend/home')}}"><img src="{{asset('fontend/images/home/logo.png')}}" alt="" /></a>
						</div>
				   ...
				   ?>
					<div class="col-md-8 clearfix">
						<div class="shop-menu clearfix pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{{url('/fontend/account')}}"><i class="fa fa-user"></i> Account</a></li>
								<li><a href=""><i class="fa fa-star"></i> Wishlist</a></li>
								<li><a href="{{url('/fontend/checkout')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li> <a  href="{{url('/fontend/cart')}}"><i class="fa fa-shopping-cart"></i> Cart <span class="cart-count badge-circle"><?php if(isset($qty)){ echo $qtyy; }?></span> </a>
								</li>
								<?php 
								if(Auth::Check()){
								?>
								...
								?>
										<li><a href="{{url('/fontend/login')}}"><i class="fa fa-lock"></i> Login</a></li>
								<?php
								}
								?>
							</ul>
					...
					<div class="col-sm-8">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="{{url('/fontend/home')}}" class="active">Home</a></li>
								<li class="dropdown"><a href="#">Shop<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{url('/fontend/shop')}}">Products</a></li>
										{{-- <li><a href="{{url('/fontend/shop/deltai/{id}')}}">Product Details</a></li>  --}}
										<li><a href="checkout.html">Checkout</a></li> 
										<li><a href="{{url('/fontend/cart')}}">Cartt </a></li> 
										<li><a href="login.html">Login</a></li> 
                                    </ul>
                                </li> 
								<li class="dropdown"><a href="{{url('/fontend/blog')}}">Blog<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
                                        <li><a href="{{url('/fontend/blog')}}">Blog List</a></li>
										{{-- <li><a href="{{url('/fontend/blog/detail')}}">Blog Single</a></li> --}}
                                    </ul>
                                </li> 
								<li><a href="{{url('/fontend/shop/error')}}">404</a></li>
								<li><a href="{{url('/fontend/shop/contact')}}">Contact</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-4">
						<form action="{{url('/fontend/home/search')}}" method="POST">
							@csrf
							<div class="search_box pull-right">
								<input type="text" name="keywords" placeholder="Search"/>
								{{-- <button type="submit" name="key" class="btn btn-info">Tìm Kiếm</button> --}}
								<input type="submit" name="key" style="margin-top: 0px; color:#110707;  width: 100px;" class=" btn btn-success btn-sm" value="Tìm Kiếm">
							</div>
						</form>
					</div>
				</div>
