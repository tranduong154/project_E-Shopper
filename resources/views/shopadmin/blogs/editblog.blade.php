                ...
                <div class="card card-body">
                    <form class="form-horizontal m-t-30" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" value="<?php echo $value['image']; ?>" name="image">
                        </div>
                     
                        <div class="form-group col-md-12">
                                <label >Content</label>
                                <textarea class="form-control" id="demo" value="<?php echo $value['ghichu']; ?>" name="ghichu"></textarea>
                             </div>     
                             <tfoot>
                                <tr>
                                    <td colspan="8">
